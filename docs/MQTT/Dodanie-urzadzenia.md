...
3. Pojawi się okienko (jeśli go nie widzisz przejdź do [Brak wykrytego urządzenia](#brak-wykrytego-urządzenia)):   
...
5. Przejdź do [integracja](../MQTT/Integracja.md) urządzeń     
