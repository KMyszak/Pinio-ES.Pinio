...
**Nie wymaga to ponownego podłączania urządzenia kablem USB**.
...
1. Wybierz z paska bocznym **ESPHome Builder** (opcja [**Pokaż na pasku bocznym**](Instalacja-dodatku-ESPHome.md)):    
...
5. Urządzenie automatycznie się zrestartuje i po kilku sekundach wczyta nową konfigurację
    ...
    !!! success "Od tego momentu jest gotowe do pracy z nowym firmware"
