...
4. Zaznacz **Obserwator**, **Pokaż na pasku bocznym** i **Uruchom** dodatek:  
    ...
    <img width="403" height="258" alt="obraz" src="https://github.com/user-attachments/assets/32e3cd7b-12b8-4760-b67c-acc5a7ae2bdb" />

5. Przejdź dalej do tworzenia [**konfiguracji** :material-open-in-new:](../../Pinio_ESPHome/Pierwsza-konfiguracja-ESPHome)