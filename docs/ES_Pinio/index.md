...
**ES.Pinio** bazuje na popularnym układzie **ESP8266** (*ESP-12F*), dzięki czemu urządzenie jest kompatybilne z oprogramowaniem **Tasmota**, **ESPHome**, a także pozwala na wgranie własnego firmware. 
...
- **wsparcie:** szczegółowa dokumentacja, instrukcja krok po kroku konfiguracji i integracji
