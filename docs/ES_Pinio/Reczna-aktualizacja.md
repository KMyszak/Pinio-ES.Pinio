...
!!! quote "Dla urządzeń ES.Pinio *BEZ* wbudowanego konwertera - wymagany jest *osobny* konwerter USB-UART"
...
- wymagane **jedynie** podpięcie ES.Pinio przez przewód microUSB oraz dedykowany program
- prosta i intuicyjna obsługa
- dodatkowa możliwość zmiany podstawowych ustawień **Tasmota** w programie