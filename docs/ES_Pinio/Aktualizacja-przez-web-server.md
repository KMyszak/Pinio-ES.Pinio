...
**Tasmota** posiada wbudowany web serwer, który umożliwia bezpośrednią aktualizację firmware bez konieczności używania dodatkowych narzędzi. Poniższe kroki pokazują, jak wgrać najnowszą wersję.
...
4. Po automatycznym restarcie na stronie głównej pojawi się **MINIMAL firmware**, po drugim zostanie wczytany aktualny stan **GPIO** - aktualizacja jest zakończona.    
