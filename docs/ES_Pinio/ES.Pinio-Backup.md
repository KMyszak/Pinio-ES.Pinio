...
3. Wybierz odpowiedni plik `.dmp` i kliknij `Start restore`:  
    
    <img width="386" height="295" alt="obraz" src="https://github.com/user-attachments/assets/179dc3b7-2b3d-455e-bf15-d4148722a846" />
    
4. Prawidłowo przeprowadzony proces zakończy się komunikatem:  

    <img width="386" height="295" alt="499364558-39430a16-5a88-42b0-81b3-67de6410770e" src="https://github.com/user-attachments/assets/3c8dcdb2-e858-4819-9fe3-6dad6a507a7e" />
