Aby połączyć ES.Pinio z Home Assistant należy znać **IP** brokera `MQTT`, **login** oraz **hasło**.   
...
7. Po odświeżeniu strony, jeśli wszystko zostało poprawnie ustawione, Home Assistant automatycznie wykryje 15 dostępnych encji, które możesz wykorzystać w dalszej integracji:      
    ...
    !!! info ""
        ...
        W tym miejscu można urządzeniu zmienić nazwę, etykietę oraz przypisać do obszaru klikając ikonę ołówka:  
