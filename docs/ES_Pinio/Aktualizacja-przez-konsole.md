...
Urządzenie można zaktualizować korzystając z *wbudowanej konsoli* w **web UI Tasmota**, **MQTT** lub przez **web request**.
...
4. Rozpozcznij aktualizację z serwera OTA wpisując polecenie `Upgrade 1`:
    ```
    Upgrade 1
    ```
    <img width="950" height="64" alt="obraz" src="https://github.com/user-attachments/assets/deb04f79-3ecd-4e1e-9651-881803e855fd" />

5. Poczekaj na zakończenie procesu aktualizacji, a następnie sprawdź wersję Tasmota.   
W konsoli możesz użyć komendy `Status 2`:
    ```
    Status 2
    ```
