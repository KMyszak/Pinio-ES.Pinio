...
Po zakończeniu konfiguracji modułu i przypisaniu funkcji **GPIO** należy wprowadzić w konsoli Tasmoty kilka poleceń niezbędnych do poprawnego działania urządzenia. Komendy te aktywują obsługę wejść, integrację z **MQTT**, zachowanie diody statusowej. 
...
3. W konsoli wpisz kolejno poniższe komendy (każdą zatwierdź klawiszem **Enter**):
    ...
    | <pre><code>LedState 4   </code></pre>     | Ustawienie trybu diody LED (STA) - więcej o [trybach :material-open-in-new:](Status-urzadzenia.md#tryby-diody-sta)  |
